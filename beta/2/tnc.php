...
<div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcumb_title">
                    ...
                    <h4>Some Important Terms of Services to be followed from our Rowdy Team</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="legal">
        <div class="container">
            <div class="row">
                <div class="col-md-12  legalhead text-center ">
                    <h3 class="text-center">TERMS OF SERVICE</h3>
                </div>
                <div class="col-md-12 ">
                    <h4 class="section-head">OVERVIEW</h4>
                    <p class="section-para">
                        This website is operated by Rowdymeals. Throughout the site, the terms “we”, “us” and “our”
                        refer to Rowdymeals. Rowdymeals offers this website, including all information, tools and
                    ...
                    <h4 class="section-head">SECTION 1 - ONLINE STORE TERMS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 2 - GENERAL CONDITIONS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-heaad">SECTION 3 - MODIFICATIONS TO THE SERVICE AND PRICES</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 4 - PRODUCTS OR SERVICES</h4>
                    <p class="section-para">
                        ...
                        any colour will be accurate. <br>
                    ...
                    <h4 class="section-head">SECTION 5 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 6 - OPTIONAL TOOLS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 7 - THIRD-PARTY LINKS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 8 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 9 - PERSONAL INFORMATION</h4>
                    <p class="section-para">
                        Your submission of personal information through the store is governed by our Privacy Policy.

                    </p>
                    <h4 class="section-head">SECTION 10 - ERRORS, INACCURACIES AND OMISSIONS</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 11 - PROHIBITED USES</h4>
                    <p class="section-para">
                    ...
                    <h4 class="section-head">SECTION 12 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h4>
                    <p class="section-para">
                        ...
                        In no case shall Rowdymeals our directors, officers, employees, affiliates, agents, contractors,
                    ...
                    <h4 class="section-head">SECTION 13 - INDEMNIFICATION</h4>
                    <p class="section-para">
                    You agree to indemnify, defend and hold harmless Rowdymeals and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.


                    </p>
                    <h4 class="section-head">SECTION 14 - SEVERABILITY</h4>
                    <p class="section-para">
                    In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.


                    </p>
                    <h4 class="section-head">SECTION 15 - TERMINATION</h4>
                    <p class="section-para">
...
If in our sole judgment you fail, or we suspect that you have failed, to comply with any term or provision of these Terms of Service, we also may terminate this agreement at any time without notice and you will remain liable for all amounts due up to and including the date of termination; and/or accordingly may deny you access to our Services (or any part thereof). <br>
                    ...
                    <h4 class="section-head">SECTION 16 - ENTIRE AGREEMENT</h4>
                    <p class="section-para">
...
Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party. <br>
                    ...
                    <h4 class="section-head">SECTION 17 - GOVERNING LAW</h4>
                    <p class="section-para">
                    These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India and jurisdiction of Haridwar, Uttarakhand.


                    </p>
                    <h4 class="section-head">SECTION 18 - CHANGES TO TERMS OF SERVICE</h4>
                    <p class="section-para">
...
We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.
                    ...
                    <h4 class="section-head">SECTION 19 - CONTACT INFORMATION</h4>
                    <p class="section-para">
                    Questions about the Terms of Service should be sent to us at 
                    <a href="mailto:hello@rowdymeals.com">hello@rowdymeals.com</a> , Phone - 7617477477.
