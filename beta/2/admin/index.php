	                        ...
	                        if(is_array($row))
								{
                                    	$_SESSION["adm_id"] = $row['adm_id'];
										 header("refresh:1;url=http://rowdymeals.com/admin/dashboard.php");
										   echo "<script>window.location.href='https://rowdymeals.com/admin/dashboard.php'</script>";
	                            } 
							else
							    {
...
<div class="container">
  <div class="info">
    <h1>ROWDY MEALS  </h1><span> Admin Login</span>
  </div>
</div>
<div class="form">
