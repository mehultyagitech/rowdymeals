...
<?php include("inc/header.php"); ?>
        <div class="page-wrapper">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item  white-txt"> <div class=" white-txt"><i class="fa fa-clock-o"></i> <?php echo $rows['o_hr']; ?> - <?php echo $rows['c_hr']; ?> </div>
																		 </li>
                                        <li class="nav-item  white-txt"><div class=" white-txt"><i class="fa fa-check"></i> Min ₹150</div> </li>
                                        <li class="nav-item  white-txt"><div class=" white-txt"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div> </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container m-t-30 ">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2 scollb sm-d-none"  style="position: sticky; top: 80px;overflow-y: scroll;height:700px;">
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>#qqw" >
...
if ($item_total >= 148.99) {
  echo ' <a href="checkout.php?res_id='.$_GET['res_id'].'>&action=check"  class="btn theme-btn btn-lg">Checkout</a>';
    ...
    echo ' <a href="#" class="btn theme-btn btn-sm" style=" font-size: 1.0rem;">Minimum order <br>QTY is 150 ₹</a>
...
?>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-10">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h5 class="widgt-title text-dark">
                             Menu 
                           ...
                           <div class="NOTIFY widgt-title text-dark" style="color:#000;">
										  <?php
										  			if(isset($_session["prodadd"]))
										  			{
										  			    echo $_session["prodadd"];
										  			    
										  			}
										  			
										  				if(isset($_session["prodRemov"]))
										  				{
										  			    echo $_session["prodRemov"];
										  				}
										  ?>
										  </div>
                            ...
                            <div class="food-item" id="qqw">
                                    <div class="row">
                                    <div class="col-md-12">
					             	<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from dishes where rs_id='$_GET[res_id]' and status='1'");
									$stmt->execute();
									...
									foreach($products as $product)
                                        ...
                                        <div class="col-md-6">
                                        <div class="col-xs-12 col-sm-12 col-lg-12 bta">
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>#qqw' >
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/dishes/'.$product['img'].'" alt="'.$product['title'].'">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
										  ...
										  <input class="" type="number" name="quantity"  style="margin-left:10px;" min="1" max="15" value="1" size="1" />
										  <input type="submit" class="btn theme-btn trigger-success" id="myid1" style="margin-left:10px;margin-bottom: 5px;" value="Add to cart"/>
