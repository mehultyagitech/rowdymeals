...
<?php $_SESSION['url'] = $_SERVER['HTTP_REFERRER'];?>
        <!-- banner part starts -->
         ...
         <div class="page-wrapper">
            <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:650px;overflow:hidden;visibility:hidden;">
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:650px;overflow:hidden;">
                         <div>
                <img data-u="image" data-src="images/img/poster1.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%" style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
                <!--<a  class="js__slider_button" href="https://axenic-uv.com/" style="background-color:; color:#fff; position: absolute;bottom: 14%;left: 9%;padding: 10px 43px;border-radius: 50px;font-family: 'Poppins', sans-serif;font-size: 14px; "> </a>-->
            </div>
                      <div>
                <img data-u="image" data-src="images/img/poster2.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%" style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
                <!--<a  class="js__slider_button" href="https://axenic-uv.com/product-detail/Stalwart-Pro-UVC-LED-Disinfection-High-Bay" style="background-color:#EC6523; color:#fff; position: absolute;bottom: 14%;left: 9%;padding: 10px 43px;border-radius: 50px;font-family: 'Poppins', sans-serif;font-size: 14px; ">View Product </a>-->
            </div>
                      <div>
                <img data-u="image" data-src="images/img/poster3.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%" style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
                <!--<a  class="js__slider_button" href="https://axenic-uv.com/product-detail/HOVER-LED-UV-Disinfection-Panel-Light" style="background-color:#0C7F79; color:#fff; position: absolute;bottom: 14%;left: 9%;padding: 10px 43px;border-radius: 50px;font-family: 'Poppins', sans-serif;font-size: 14px; ">View Product </a>-->
            </div>
        ...
        <!--            <h5 class="font-white space-xs">Food for all your Cravings ! </h5>-->
        ...
        <!--                </form>-->
        <!--            </div> -->-->
        <!--            <div class="steps" style="padding-top: 25px;">-->
