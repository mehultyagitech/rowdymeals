...
$ret1=mysqli_query($db,"select * FROM users_orders uo INNER JOIN users u  on uo.u_id=u.u_id  where uo.o_id='".$_GET['newform_id']."'");
...
?>
    <tr>
      <td colspan="2"><b><?php echo $ro['f_name'];?>'s profile</b></td>
    ...
    <tr height="50">
      <td><b>Reg Date:</b></td>
      <td><?php echo htmlentities($ro['date']); ?></td>
    </tr>
	
	<tr height="50">
      <td><b>firstname:</b></td>
      <td><?php echo htmlentities($ro['f_name']); ?></td>
    </tr>
	<tr height="50">
      <td><b>lastname:</b></td>
      <td><?php echo htmlentities($ro['l_name']); ?></td>
    </tr>
...
<tr height="50">
    ...
    <tr height="50">
      <td><b>User Area:</b></td>
      <td><?php echo htmlentities($ro['area']); ?></td>
    </tr>
