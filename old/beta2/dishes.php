...
<?php include("inc/header.php"); ?>
        <div class="page-wrapper">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <div class=""><i class="fa fa-clock-o"></i> <?php echo $rows['o_hr']; ?> - <?php echo $rows['c_hr']; ?> </div>
																		 </li>
                                        <li class="nav-item"><div class=""><i class="fa fa-check"></i> Min ₹150</div> </li>
                                        <li class="nav-item"><div class=""><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div> </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container m-t-30 ">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2"  style="position: sticky; top: 80px;overflow-y: scroll;">
                            ...
                            <div class="food-item" id="qqw">
									...
									foreach($products as $product)
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>#qqw'>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:10px;margin-bottom: 5px;" value="Add to cart" />
                                           </div>
										</div>
										</form>
                                        </div>
