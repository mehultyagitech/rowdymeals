...
<script src="https://axenic-uv.com/assets/js/jssor.slider-28.0.0.min.js"></script>
<?php $_SESSION['url'] = $_SERVER['HTTP_REFERRER'];?>
<!-- banner part starts -->
...
<div class="page-wrapper">
    <div id="jssor_1"
        style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:650px;overflow:hidden;visibility:hidden;">
        <div data-u="slides"
            style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:650px;overflow:hidden;">
            <div>
                <img data-u="image" data-src="images/img/poster6.png" />
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
            <a class="js__slider_button" href="https://rowdymeals.com/dishes.php?res_id=1" style="background-color: rgb(0 0 0);color: rgb(255, 255, 255);position: absolute;bottom: 14%;left: 10%;padding: 10px 43px;border-radius: 50px;font-family: Poppins, sans-serif;font-size: 14px;z-index: 2;" data-events="auto" data-display="block">Explore Dishes </a> 
            </div>
            <div>
                <img data-u="image" data-src="images/img/poster4.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
            </div>
            <div>
                <img data-u="image" data-src="images/img/poster5.png" />
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
                 <a class="js__slider_button" href="https://rowdymeals.com/dishes.php?res_id=4" style="background-color: #f05c4d; color: rgb(255, 255, 255); position: absolute; bottom: 14%; left: 20%; padding: 10px 43px; border-radius: 50px; font-family: Poppins, sans-serif; font-size: 14px; z-index: 1;" data-events="auto" data-display="block">Explore Dishes </a>     
          
            </div>
            <div>
                <img data-u="image" data-src="images/img/poster1.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
            </div>
            ...
            <div>
                <img data-u="image" data-src="images/img/poster3.jpg" />
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:650px;position:absolute;">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 " style="margin-top:2rem">
                    <center> <a class="" href="https://rowdymeals.com/restaurants.php"
                            style="background-color: rgb(0 0 0);color: rgb(255, 255, 255);padding: 25px 50px;border-radius: 50px;font-family: Poppins, sans-serif;font-size: 14px;z-index: 1;"
                            data-events="auto" data-display="block">Explore Restaurants </a>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php 
						...
						$query_res= mysqli_query($db,"select * from dishes where featured='yes' LIMIT 4"); 
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-3 food-item">
                                                            ...
                                                            <form method="post" action="dishes.php?res_id='.$r['rs_id'].'&action=add&id='.$r['d_id'].'">
                                                                ...
                                                                <input class="pull-right" type="number" name="quantity"  min="1" max="15" value="1" size="1" />
                                                                 ...
                                                                 <input type="submit" class="btn  theme-btn-dash" style="margin-top:10px;margin-left: auto;margin-right: auto;margin-bottom: 10px;" value="Add to cart" />
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We've got your covered with menus from over many delivery restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <p>Choose over many Veg and Non Veg tasty delights to get your cravings fulfill ! </p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your food delivered! And enjoy your meal! Pay online on delivery too.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Pay by Cash or UPI on delivery.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="restaurant-listing">
                    ...
                    <?php  //fetching records from table and filter using html data-filter tag
						$ress= mysqli_query($db,"select * from restaurant where status='1' ORDER BY prior ASC");  
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                                    ...
                                                                    <div class="cost"><i class="fa fa-clock-o"></i> '.$rows['o_hr'].'- '.$rows['c_hr'].'</div>
																		<div class="cost"><i class="fa fa-check"></i> Min ₹150</div>
